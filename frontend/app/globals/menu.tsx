        ...
        <nav className="fixed bottom-0 left-0 right-0 bg-background border-t border-border">
            <div className="flex justify-between items-center max-w-screen-sm mx-auto px-4 py-2">
                <Button
                    variant="ghost"
                    size="icon"
                    style={ currentPath === "/" ? { color: "orange" } : undefined }
                    className="text-muted-foreground hover:opacity-85"
                >
                ...
                <Button
                    variant="ghost"
                    size="icon"
                    style={ currentPath.includes("/browse") ? { color: "orange" } : undefined }
                    className="text-muted-foreground hover:opacity-85"
                >
                ...
                <Button
                    variant="ghost"
                    size="icon"
                    style={ currentPath === "/dashboard" ? { color: "orange" } : undefined }
                    className="text-muted-foreground hover:opacity-85"
                >
